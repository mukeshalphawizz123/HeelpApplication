package com.freelanceapp.myRequestPkg.MyRequestAdapter;
...
public class MyRequestsecAdapter extends RecyclerView.Adapter<MyRequestsecAdapter.ViewHolder> {
    ...
    public interface MyRequestAppOnClickListener {
        void myRequestOnClick(View v, int Position, String text);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            myRequestAppOnClickListener.myRequestOnClick(v, getAdapterPosition(), tvMyRequestFilterStatus.getText().toString());
