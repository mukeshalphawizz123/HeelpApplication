package com.freelanceapp.myRequestPkg.MyRequestOptionsPkg.myDemandOngoingPkg;
...
import com.freelanceapp.myRequestPkg.MyRequestOptionsPkg.myDemandOngoingPkg.Adapter.MyRequestOngoingAdapter;
import com.freelanceapp.myRequestPkg.MyRequestOptionsPkg.myDemandOngoingPkg.demandProgressModlePkg.Datum;
...
public class MyDemandsOngoingActivity extends Fragment implements MyRequestOngoingAdapter.MyRequestOngoingAppOnClickListener, View.OnClickListener {
    ...
    private void myOnProgressApi(String status) {
        pbDemandProgress.setVisibility(View.VISIBLE);
        apiServices.demandPorgress(status).enqueue(new Callback<DemandOnProgressModle>() {
            @Override
