...
public class MyDemandOngoingChildAdapter extends RecyclerView.Adapter<MyDemandOngoingChildAdapter.ViewHolder> {
    private Context context;
    private ArrayList<String> fileImageList;
    FileDownloading fileDownloading;


    public MyDemandOngoingChildAdapter(Context context) {
    ...
    @NonNull
    @Override
    public MyDemandOngoingChildAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyDemandOngoingChildAdapter.ViewHolder holder, int position) {
